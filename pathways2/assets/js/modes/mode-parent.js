...
import { getState, currentYear, encodePlan } from '../state.js?v=2.13.0';
import { reach, sortReaches, lever } from '../engine/reach.js?v=2.13.0';
import { parentMoneyBlock } from './mode-money.js?v=2.13.0';
