...
import { getState, setAim, toggleAction, currentYear, setMode } from '../state.js?v=2.8.0';
import { reach } from '../engine/reach.js?v=2.8.0';
import { wantWorkBlock, openSectorSheet } from './mode-work.js?v=2.8.0';
