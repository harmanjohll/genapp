...
import { openSheet, onSheetAction } from '../components/sheet.js?v=2.12.0';
import { getState, setAim, toggleAction, currentYear, setMode } from '../state.js?v=2.12.0';
import { reach } from '../engine/reach.js?v=2.12.0';
import { wantWorkBlock, openSectorSheet } from './mode-work.js?v=2.12.0';
