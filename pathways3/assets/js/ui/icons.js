...
const PATHS = {
  ...
  // Plan: a folded map.
  map: '<path d="M2.6 12.9V4.3l3.6-1.4 3.6 1.4 3.6-1.4v8.6l-3.6 1.4-3.6-1.4z"/><path d="M6.2 2.9v8.6M9.8 4.3v8.6"/>',
  // Play: a life in motion, not a media control: the age roundel travelling.
  play: '<circle cx="8" cy="8" r="5.5"/><path d="M6.7 5.9v4.2L10.3 8z" fill="currentColor" stroke="none"/>',
  // Act: a flag planted.
  flag: '<path d="M4.2 13.6V2.8"/><path d="M4.2 3.4h7.4l-1.7 2.3 1.7 2.3H4.2"/>',
