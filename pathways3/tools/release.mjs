...
//
//   node pathways3/tools/release.mjs 3.0.1   set a new version everywhere
//   node pathways3/tools/release.mjs         re-stamp the current one
//
...
const SUBRESOURCES = ['assets/css/tokens3.css', 'assets/css/base.css', 'assets/css/app.css', 'assets/css/play.css', 'assets/fonts/literata-var-latin.woff2', 'assets/js/main.js'];
...
// 2b. The service worker's cache key. A new build must open a new cache or
//     visit two keeps serving the old app forever; the version sweep fails
//     if this and the meta tag disagree.
